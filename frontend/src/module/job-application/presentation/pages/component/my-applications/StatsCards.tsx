...
import { FileText, Calendar, CheckCircle2, Timer, ArrowUpRight } from 'lucide-react';
...
export const StatsCards: React.FC<Props> = ({ apps }) => {
  const stats = [
    ...
    },
    {
      ...
      value: apps.filter((a) => a.getStatus() === ApplicationStatus.SELECTED).length,
      sub: 'Congratulations!',
      icon: CheckCircle2,
    ...
    <div className="grid grid-cols-4 gap-4 mb-6">
      {stats.map((s, i) => (
        ...
        >
          ...
          <p className={`text-3xl font-black ${s.accentText} leading-none mb-1.5`}>
            {s.value}
          </p>
