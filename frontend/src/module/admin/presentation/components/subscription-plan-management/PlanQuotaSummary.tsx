...
export default function PlanQuotaSummary({ formData }: PlanQuotaSummaryProps) {
  return (
    <div className="rounded-2xl border border-zinc-200 bg-white p-5">
      <h3 className="font-semibold text-zinc-900 mb-4 text-sm">Quota Summary</h3>
      <div className="space-y-3">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-semibold text-zinc-800">
            {formData.jobPostsPerMonth === -1 ? "Unlimited" : formData.jobPostsPerMonth}
          </span>
        </div>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-semibold text-zinc-800">
            {formData.screeningCredits === -1 ? "Unlimited" : formData.screeningCredits}
          </span>
        </div>
