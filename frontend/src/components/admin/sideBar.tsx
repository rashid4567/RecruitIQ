...
const menuItems: MenuItem[] = [
  ...
  { icon: UsersRound, label: "Candidates", href: "/admin/candidates" },
  { icon: Briefcase, label: "Job Posts", href: "/admin/jobPosts" },
...
// Desktop-only persistent sidebar (lg+, 1024px and up).
// AdminHeader owns ALL navigation below lg — mobile hamburger drawer,
// which also covers tablet widths. This component must render nothing
// below lg or you'll get two navigation UIs on screen at once again.
