...
export function CandidateProfileContent({
  ...
  const experienceLevel = getExperienceLevel(profile.experienceYears ?? 0);
          ...
          <div className="flex flex-col sm:flex-row items-start gap-7">
            ...
            <div className="flex-1 space-y-3">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span
                  className={`text-xs font-semibold px-2.5 py-1 rounded-full ${experienceLevel.pill}`}
                >
              ...
              <div className="flex flex-wrap gap-2">
                {profile.currentJobLocation && (
                  <MetaChip
                    ...
                    label={profile.currentJobLocation}
                  />
                )}
                <MetaChip
        ...
        <div className="border-t border-gray-50 px-6 sm:px-10 py-5">
          <div className="flex flex-wrap gap-4">
            <StatCard
              ...
              accent="bg-amber-50"
              label="Experience"
              value={getExperienceDisplay(profile.experienceYears ?? 0)}
            />
              ...
              {profile.skills.length >= 3 && (
                <div className="mt-5 flex items-start gap-3 p-4 bg-amber-50 rounded-xl border border-amber-100">
                  ...
                  <p className="text-sm text-amber-700">
                    ...
                    {profile.skills.slice(0, 3).join(", ")} are trending this
                    year.
                  </p>
                </div>
              )}
