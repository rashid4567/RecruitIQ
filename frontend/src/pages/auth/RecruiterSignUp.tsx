      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-xl shadow-slate-100/50 backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex gap-4 pt-6">
              <button
                ...
                className="flex-1 border-2 border-slate-300 hover:border-slate-400 hover:bg-slate-50 text-slate-900 font-bold py-3.5 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
              >
                Back
              </button>
              <button
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <button
              type="button"
              className="border-2 border-slate-300 hover:border-slate-400 hover:bg-slate-50 text-slate-900 font-semibold py-3.5 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group"
            >
            ...
            <button
              type="button"
              className="bg-blue-700 hover:bg-blue-800 text-white font-semibold py-3.5 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-blue-700/40"
            >
