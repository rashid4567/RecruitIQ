      ...
      {selectedCount > 0 && (
        <div className="mt-3 pt-3 border-t border-slate-100 flex items-center gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-1">
            <button
              disabled={loading}
              onClick={() => handleBulkUpdate(ApplicationStatus.SHORTLISTED)}
            ...
            <button
              disabled={loading}
              onClick={() => handleBulkUpdate(ApplicationStatus.SELECTED)}
            ...
            <button
              disabled={loading}
              onClick={() => handleBulkUpdate(ApplicationStatus.REJECTED)}
