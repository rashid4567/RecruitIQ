...
import { InterviewCard } from "../component/recruiter-application.detail/Interviewpanel";
import {
  ResumeCard,
  ApplicationInfoCard,
...
function AIAnalysisSection({
  ...
  return (
    <>
     {rec && <RecBanner rec={rec} analyzedAt={ai.analyzedAt} overallScore={ai.overallScore} />}
      <AIScores ai={ai} />
      {ai.summary && (
        <Section
          title="AI Summary"
