          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-widest font-medium">Total Subscribers</p>
                  <p className="text-4xl font-bold text-gray-900 mt-3">{data?.total || 0}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-widest font-medium">Active Now</p>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-widest font-medium">Growth This Month</p>
                  <p className="text-4xl font-bold text-gray-900 mt-3">+18%</p>
                  <p className="text-xs text-emerald-500 font-medium mt-1">↑ from last month</p>
                </div>
                  ...
                  {(isLoading || isFetching) ? (
                    ...
                    <tr>
                      <td colSpan={8} className="py-20 text-center">
                        <p className="text-sm text-red-500 mb-3">Unable to load subscription data</p>
                        <button
                          onClick={refetch}
