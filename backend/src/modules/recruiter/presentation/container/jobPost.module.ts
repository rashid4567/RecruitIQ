import { CreateJobUseCase } from "../../../job/application/usecase/job/create-job.usecase";
...
const createJobPostUC = new CreateJobUseCase(jobPostRepository, recruiterSubscriptionRepo);
