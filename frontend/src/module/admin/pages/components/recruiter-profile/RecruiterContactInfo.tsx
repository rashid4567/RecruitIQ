...
const SUBSCRIPTION_CONFIG = {
  free: {
    label: "Free Plan",
    pill: "bg-gray-50 text-gray-600 ring-1 ring-gray-200",
  },
  active: {
    label: "Pro Active",
...
export function RecruiterContactInfo({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      <div className="h-1 w-full bg-linear-to-r from-slate-300 via-gray-200 to-slate-300" />
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          <div className="lg:col-span-4 flex flex-col items-center lg:items-start gap-4 text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
              <span
                className={`text-xs font-semibold px-2.5 py-1 rounded-full ${verificationStyle.pill}`}
              >
                {verificationStyle.label}
              </span>
              <span
                className={`text-xs font-semibold px-2.5 py-1 rounded-full ${subscriptionStyle.pill}`}
              >
