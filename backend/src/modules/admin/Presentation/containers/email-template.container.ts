...
import { SendEmailByEventUseCase } from "../../Application/use-Cases/email-template/send-email-by-event.usecase";
...
export const sendEmailByEventUC  = new SendEmailByEventUseCase(emailTemplateRepo, emailService);
...
const sendTestEmailUC = new SendTestEmailUseCase(
  emailTemplateRepo,
  emailService,
);
