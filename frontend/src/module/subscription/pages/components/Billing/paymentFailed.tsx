...
function GlitchText({ text }: { text: string }) {
  ...
  return (
    <span className="relative inline-block">
      ...
      {glitch && (
        <>
          <span className="absolute inset-0 text-red-400 g1" aria-hidden="true">
            {text}
          </span>
          <span
            className="absolute inset-0 text-orange-400 g2"
            aria-hidden="true"
          >
            {text}
          </span>
...
export default function PaymentFailedPage() {
  ...
  const badgeGrad = sub
    ? (planBadgeColor[sub.planType] ?? "from-red-500 to-rose-600")
  ...
  const commonReasons = [
    {
      ...
      fix: "Check your account balance",
    },
    {
      icon: "🔒",
      reason: "Card declined by bank",
      fix: "Contact your bank or try another card",
    },
    {
      icon: "⏱️",
      reason: "Session timed out",
      fix: "The payment window may have expired",
    },
    {
      icon: "🌐",
      reason: "Network interruption",
      fix: "Unstable connection during checkout",
    },
  ];
    ...
    <div className="min-h-screen bg-[#080404] relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-16 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          ...
          >
            <div
              className={`h-1 w-full bg-linear-to-r ${badgeGrad} opacity-60`}
            />
            <div className="p-7 space-y-6">
              ...
              <div className="flex items-start gap-3 bg-red-500/8 border border-red-500/20 rounded-xl px-4 py-3">
                ...
                <p className="text-zinc-400 text-xs leading-relaxed">
                  ...
                  . You can safely retry the payment or choose a different plan.
                  Your account data is intact.
                </p>
              </div>
            </div>
          </div>
