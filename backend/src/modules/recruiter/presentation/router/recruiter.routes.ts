...
import OfferLetterRouter from "../../../offer-letter/presentation/router/recruiter.offer.routes";
...
router.put(
  RECRUITER_ROUTES.COMPLETE_PROFILE,
...
router.use(RECRUITER_ROUTES.OFFER, OfferLetterRouter);
