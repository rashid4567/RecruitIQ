...
function TableHeader() {
  return (
    <thead className="bg-slate-50/70 sticky top-0 z-10">
      <tr>
        <th className="w-[26%] px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">
          Candidate
        </th>
        <th className="w-[20%] px-5 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">
          Skills
        </th>
        <th className="w-[11%] px-5 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">
          Experience
        </th>
        <th className="w-[14%] px-5 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">
          Location
        </th>
        <th className="w-[9%] px-4 py-3 text-center text-xs font-semibold text-slate-600 uppercase tracking-wider">
          Apps
        </th>
        <th className="w-[10%] px-4 py-3 text-center text-xs font-semibold text-slate-600 uppercase tracking-wider">
          Status
        </th>
        <th className="w-[10%] px-5 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">
          Registered
        </th>
        <th className="w-[6%] px-6 py-3 text-right pr-8 text-xs font-semibold text-slate-600 uppercase tracking-wider">
          Actions
        </th>
      </tr>
    </thead>
