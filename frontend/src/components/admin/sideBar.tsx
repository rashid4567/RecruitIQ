...
export default function Sidebar() {
  ...
  return (
    <div
      className={`${collapsed ? "w-20" : "w-64"} bg-white border-r border-gray-200 flex flex-col h-screen transition-all duration-300 sticky top-0`}
    >
        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {!collapsed && (
                <span
                  className={`text-sm font-medium truncate ${active ? "font-semibold" : ""}`}
                >
                  {item.label}
                </span>
              )}
