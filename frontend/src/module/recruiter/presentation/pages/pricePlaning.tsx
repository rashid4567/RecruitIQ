            ...
            {plans.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`rounded-2xl p-6 lg:p-8 h-full ${isHighlighted ? "bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 text-white" : "bg-white border border-slate-200"}`}
                  >
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 px-8 py-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  ...
                  <div className="flex flex-col items-start md:items-end gap-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <span className="bg-white/10 text-white text-xs px-3 py-1 rounded-full">
                        {getDisplayScreeningCredits(selectedPlan)} screening
                        credits
                      </span>
                    </div>

                    <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all">
                ...
                <div className="flex flex-wrap gap-2 mt-6">
                  {selectedPlan.featuresAccess?.interviewScheduling && (
                    <span className="text-xs px-3 py-1 rounded-full font-medium bg-emerald-500/20 text-emerald-300">
                  ...
                  {selectedPlan.razorpayPlanId && (
                    <span className="text-xs px-3 py-1 rounded-full font-medium bg-blue-500/20 text-blue-300">
                      Razorpay Enabled
                    </span>
                  )}
                </div>
                    ...
                    <button
                      onClick={() =>
                        setExpandedCategories(
                          featureCategories.map((c) => c.category),
                        )
                      }
                          ...
                          <div className="divide-y divide-slate-100">
                            {category.features.map((feature, idx) => (
                              ...
                              >
                                ...
                                {/* Mobile View */}
                                <div
                                  className="md:hidden col-span-full grid gap-2"
                                  style={{
                                ...
                                >
                                  {plans.map((plan) => (
                                    <div
                                      key={plan.id}
                                      className={`text-center p-2 rounded-lg ${selectedPlanId === plan.id ? "bg-blue-50 border border-blue-200" : "bg-slate-50"}`}
                                    >
                                ...
                                {plans.map((plan) => (
                                  <div
                                    key={plan.id}
                                    className={`hidden md:flex justify-center items-center ${selectedPlanId === plan.id ? "bg-blue-50/50 -mx-2 px-2 rounded-lg" : ""}`}
                                  >
                                    {renderFeatureValue(
                                      feature.values[plan.id],
                                      plan.id,
              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <button className="bg-white hover:bg-blue-50 text-blue-700 px-8 py-4 rounded-xl font-semibold flex items-center gap-2 transition-all shadow-lg whitespace-nowrap">
                    {getPlanCTA(selectedPlan)}
