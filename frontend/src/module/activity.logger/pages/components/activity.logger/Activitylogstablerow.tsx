...
export function ActivityLogsTableRow({ log }: ActivityLogsTableRowProps) {
  ...
  return (
    ...
    >
          ...
          <TooltipTrigger asChild>
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-[13px] font-semibold text-slate-800 truncate max-w-35 group-hover/actor:text-indigo-700 transition-colors">
                  {name}
                </p>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              ...
              <span className="text-[13px] text-slate-600 truncate max-w-30 group-hover/entity:text-indigo-700 transition-colors">
                {entityLabel}
              </span>
            </button>
          </TooltipTrigger>
      ...
      <TableCell>
        <p className="text-[13px] text-slate-600 line-clamp-2 max-w-85 leading-relaxed">
          {getDescription(log)}
        </p>
      </TableCell>
