...
import { RescheduleInterviewRequestDTO, RescheduleInterviewResponseDTO } from "../../../application/dto/rescheduleInterview.dto";
...
export class RescheduleInterviewController {
    constructor(private readonly rescheduleInterviewUC : IUseCase<RescheduleInterviewRequestDTO,RescheduleInterviewResponseDTO>){};
