  ...
  return (
    <div className="space-y-2.5">
      {items.map((item, i) => (
        ...
        >
          <div
            className={`w-7 h-7 rounded-lg ${dotColor} flex items-center justify-center text-white text-xs font-bold shrink-0 shadow-sm`}
          >
            {i + 1}
          </div>
          <Input
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm ml-10">
          Describe the role in a way that attracts the right talent
        </p>
      </div>
