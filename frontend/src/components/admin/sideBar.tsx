  ...
  const renderNavBody = (isCollapsed: boolean) => (
    <div className="flex flex-col h-full">
      ...
      <div className="border-t border-gray-200 px-3 py-4">
        {!isCollapsed ? (
          <>
            <div className="px-3 py-3 mb-3 bg-gray-50 rounded-lg transition-shadow hover:shadow-sm">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-semibold text-sm shrink-0">
                  A
                </div>
            ...
            <Button
              ...
              disabled={isLoading}
              variant="ghost"
              className="flex items-center gap-3 px-3 py-3 text-gray-700 hover:bg-slate-100 hover:text-red-600 rounded-lg transition-colors w-full group justify-start"
            >
              <LogOut
                size={20}
                className="text-gray-500 group-hover:text-red-600 transition-transform group-hover:scale-105"
              />
          ...
          <div className="flex flex-col items-center gap-3">
            <button
              onClick={handleLogout}
              className="p-3 text-gray-700 hover:bg-slate-100 hover:text-red-600 rounded-lg transition-colors group"
              title="Log Out"
              aria-label="Log out"
            >
              <LogOut
      ...
      >
        ...
        {collapsed && (
          <button
            ...
            className="mx-auto mt-2 p-1 hover:bg-slate-100 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
        ...
        <div className="flex items-center gap-2">
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="left" className="w-72 p-0 flex flex-col">
              <SheetHeader className="px-4 py-4 border-b border-gray-200 text-left">
                <SheetTitle asChild>
                  <button
