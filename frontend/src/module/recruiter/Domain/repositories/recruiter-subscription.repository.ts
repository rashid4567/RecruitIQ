...
import type { RecruiterSubscription } from "../entities/RecruiterSubscription.entity";
...
export interface RecruiterSubscriptionRepository {
  ...
  getSubscriptionHistory(pagination?: PaginationOptions): Promise<PaginatedResult<RecruiterSubscription>>;
