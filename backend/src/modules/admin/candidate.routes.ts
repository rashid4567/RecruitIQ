...
import { blockUserController, getCandidateProfileController, getCandidatesController, getRecruiterProfileController, getRecruitersController, rejectRecruiterController, unblockUserController, verifyRecruiterController } from "./candidate.module";
