      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            const style = accentStyles[feature.accent as keyof typeof accentStyles];
            return (
              <div
                key={index}
                className={`group relative bg-white rounded-2xl p-8 border border-gray-200 ring-1 ring-transparent hover:border-transparent hover:-translate-y-1 hover:shadow-xl ${style.ring} transition-all duration-300`}
              >
                <div
