...
import type { UserRole } from "@/module/auth/types/auth.types";
...
const ROLES: RoleConfig[] = [
  {
    ...
    selectedBorder:
      "border-blue-500 bg-linear-to-b from-blue-50/80 to-indigo-50/60",
  ...
  },
  {
    ...
    selectedBorder:
      "border-indigo-500 bg-linear-to-b from-indigo-50/80 to-purple-50/60",
...
export default function RoleSelection() {
  ...
  return (
    <div className="relative min-h-screen bg-linear-to-br from-slate-50 via-white to-blue-50/40 flex items-center justify-center px-5 py-10 sm:py-14 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <div className="flex items-center justify-center gap-2.5 mb-10">
          <div className="w-9 h-9 rounded-xl bg-linear-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-300/40">
          ...
          {ROLES.map((role) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg ring-2 ring-white">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="h-2 bg-slate-200/70 rounded-full overflow-hidden shadow-inner">
              <div
                className="h-full bg-linear-to-r from-blue-500 to-indigo-600 rounded-full transition-all duration-700 ease-out"
          ...
          <button
            ...
            className={[
              ...
              isRoleSelected
                ? "bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg shadow-blue-300/40 hover:shadow-xl hover:shadow-blue-400/40 hover:-translate-y-0.5 active:scale-[0.99]"
